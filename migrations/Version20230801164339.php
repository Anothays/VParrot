 ...
 */
final class Version20230801164339 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car_constructors (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE car_engine (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE car_models (id INT AUTO_INCREMENT NOT NULL, constructor_id_id INT NOT NULL, engine_id_id INT NOT NULL, name VARCHAR(30) NOT NULL, INDEX IDX_FCBEDCFBFB2CA69D (constructor_id_id), INDEX IDX_FCBEDCFB522C4A1C (engine_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cars ADD car_model_id_id INT NOT NULL, DROP model, DROP brand, DROP engine');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cars ADD model VARCHAR(255) NOT NULL, ADD brand VARCHAR(255) NOT NULL, ADD engine VARCHAR(255) NOT NULL, DROP car_model_id_id');
