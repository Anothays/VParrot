 ...
 */
final class Version20230806110728 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo ADD alt VARCHAR(255) NOT NULL, CHANGE modified_at modified_at DATETIME on update CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo DROP alt, CHANGE modified_at modified_at DATETIME DEFAULT NULL');
