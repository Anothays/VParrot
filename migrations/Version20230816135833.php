 ...
 */
final class Version20230816135833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, garage_id INT DEFAULT NULL, constructor VARCHAR(50) NOT NULL, model VARCHAR(50) NOT NULL, engine VARCHAR(50) NOT NULL, license_plate VARCHAR(9) NOT NULL, registration_year INT NOT NULL, mileage INT NOT NULL, price DOUBLE PRECISION NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modified_at DATETIME on update CURRENT_TIMESTAMP, published TINYINT(1) NOT NULL, INDEX IDX_773DE69DA76ED395 (user_id), INDEX IDX_773DE69DC4FFF555 (garage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
