 ...
 */
final class Version20230806121819 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo ADD image_size INT DEFAULT NULL, CHANGE modified_at modified_at DATETIME on update CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo DROP image_size, CHANGE modified_at modified_at DATETIME DEFAULT NULL');
