 ...
 */
final class Version20230801144336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photos DROP size, CHANGE modified_at modified_at DATETIME on update CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photos ADD size INT NOT NULL, CHANGE modified_at modified_at DATETIME DEFAULT NULL');
