 ...
 */
final class Version20230806110901 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo CHANGE modified_at modified_at DATETIME on update CURRENT_TIMESTAMP, CHANGE alt alt VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo CHANGE alt alt VARCHAR(255) NOT NULL, CHANGE modified_at modified_at DATETIME DEFAULT NULL');
