 ...
 */
final class Version20230806130335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo CHANGE modified_at modified_at DATETIME on update CURRENT_TIMESTAMP, CHANGE mime_type mime_type VARCHAR(10) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE photo CHANGE mime_type mime_type VARCHAR(255) NOT NULL, CHANGE modified_at modified_at DATETIME DEFAULT NULL');
