 ...
 */
final class Version20230727132253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE services CHANGE image_name image_name VARCHAR(255) DEFAULT NULL, CHANGE modified_at modified_at DATETIME on update CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE services CHANGE image_name image_name VARCHAR(255) NOT NULL, CHANGE modified_at modified_at DATETIME DEFAULT NULL');
